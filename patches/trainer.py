...
Patch for Training Loop Logging Consistency
-------------------------------------------
This patch updates the training loop in Dassl.Pytorch to ensure consistent handling of the `nb_remain` variable.
